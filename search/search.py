...
def uniformCostSearch(problem: SearchProblem):
    ...
    while(not queue.isEmpty()):
        ...
        if(problem.isGoalState(node)):
            ...
            successors = problem.getSuccessors(node)
            for successor, action, stepCost in successors:
                new_cost = path_cost[node] + stepCost
                if(successor not in path_cost.keys() or new_cost < path_cost[successor]):
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    path_cost[start] = start_cost
    queue.push((start, []), start_cost + heuristic(start, problem))
        ...
        if(problem.isGoalState(node)):
            ...
            for successor, action, stepCost in successors:
                ...
                if(successor not in path_cost.keys() or new_cost < path_cost[successor]):
                    ...
                    queue.update((successor, new_path), heuristic_cost)
